...
A registry dict :data:`TRAJECTORY_REGISTRY` maps string names to the
...
def make_traj_hover(
    ...
    rng : np.random.Generator
        (Unused for hover, but kept for API consistency.)
